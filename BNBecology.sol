...
contract BNBEcology {
    ...
    constructor(address payable _owner) public {
        ...
        Development_fund = address(0xECE6550FA188e51635B2659213B75101572b1Bfc);
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        Development_fund.transfer(_amount * 45 / 1000);
    ...
    function _drawPool() private {
        ...
        for(uint8 i = 0; i < 10; i++) {
            ...
            uint256 win = draw_amount * 10 / 100;
    ...
    function _transferTokenBEB(address _addr,uint256 _amount)  private{
        ...
        address BEBAddress  = address(0x8077c25A2930cE33B0f1A1610373a12E32c6ff01);
        TokenBEB  token = TokenBEB (BEBAddress ); //BEB
